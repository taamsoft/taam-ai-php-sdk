...
class GeneratePromptTemplate implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * @param int $id
     */
    public function __construct(string $status, string $maxResults, string $temperature, string $maxWords, int $id)
    {
        $this->status = $status;
     ...
     * Returns Max Words.
     */
    public function getMaxWords(): string
    {
     ...
     * @maps max_words
     */
    public function setMaxWords(string $maxWords): void
    {
        $this->maxWords = $maxWords;
    }
